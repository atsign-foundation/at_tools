...
1. Fork in GitHub https://github.com/atsign-foundation/at_tools
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_tools`)
3. Set your remotes as follows:

   ```sh
   cd at_tools
   git remote add upstream git@github.com:atsign-foundation/at_tools.git
   ...
   ```text
   origin  git@github.com:yourname/at_tools.git (fetch)
   origin  git@github.com:yourname/at_tools.git (push)
   upstream        git@github.com:atsign-foundation/at_tools.git (fetch)
