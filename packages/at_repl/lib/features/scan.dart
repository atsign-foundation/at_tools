...
Future<List<AtKey>> getAtKeys(AtClient atClient,
    {String? regex, bool showHiddenKeys = true}) async {
  return await atClient.getAtKeys(
    regex: regex,
...
Future<void> handleScan(
  ...
  try {
    outputStream.writeln(cyan.wrap(
        "Scanning for keys${regex != null ? ' with regex: $regex' : ''}..."));
