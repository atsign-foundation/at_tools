...
/// There are 3 kinds of interactions:
/// 1. getFreeAtSign -> get a free claimable atSign
/// 2. registerAtSign & registerAtSignValidate -> register the atSign that was taken from getFreeAtSign
/// 3. authenticateAtSign & authenticateAtSignValidate -> onboard an unactivated atSign (owned and already purchased) that was never onboarded before (or was just reset)
/// TODOs:
/// 1. handle different error messages TODO
/// 2. use activation key to aviod OTP? I think TODO
class ApiUtil {
  late IOClient _http;
